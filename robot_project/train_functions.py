...
def create_scenario(env_config, agent_config, train_config):
    ...
    """
    # Import the specified agent module dynamically
    try:
        ...
        raise ValueError(f"Failed to load agent: {e}. Make sure agent_module and agent_class are correctly specified in agent_config")
    
    # Remove the agent selection keys from agent_config before passing to agent
