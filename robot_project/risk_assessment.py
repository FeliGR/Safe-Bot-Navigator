...
class RiskAssessment:
    def __init__(self, grid, trap_penalty=0.05, obstacle_penalty=0.2, base_risk=0.5, risk_decay=0.05, risk_increase=0.5):
    ...
    def calculate_risk(self, pos, uncertainty_factor=0.1):
        ...
        risk = float(risk) * (1 + uncertainty_factor)  # Convert to float to ensure it's a scalar
        return risk
