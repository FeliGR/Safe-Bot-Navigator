...
def plot_comparison(agent_no_risk, agent_with_risk, window=100):
    ...
    for i, metric in enumerate(metrics, 1):
        ...
        if metric == "rewards":
            ...
            plt.plot(
                episodes,
                errors_no_risk_smooth,
                label="Sin Riesgo (Suavizado)",
                color="blue",
            )
            plt.plot(
                episodes,
                errors_with_risk_smooth,
                label="Con Riesgo (Suavizado)",
                color="orange",
            )
            ...
            plt.plot(
                episodes, agent_with_risk.train_history[metric], label="Con Riesgo"
            )
