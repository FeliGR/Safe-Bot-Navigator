...
from visualization.visualize_politic import (
...
def find_related_files(agent_dir):
    ...
    files = {"agent": None, "env": None}

    # Search patterns
    patterns = {"agent": "agent.pkl", "env": "env.pkl"}
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate all visualizations for agent results"
    )
    parser.add_argument(
        "--agents_dir",
        type=str,
        help="Directory containing trained agents",
        default=TRAINED_AGENTS_DIR,
    )
